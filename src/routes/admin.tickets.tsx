...
import { adminLogout, checkAdminUnlocked } from "@/lib/fares.functions";
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b border-border bg-navy text-navy-foreground">
        ...
        <div className="mx-auto flex max-w-[1600px] gap-1 px-4">
          ...
          <Link to="/admin/tickets" className="relative rounded-t-md border-b-2 border-gold bg-white/5 px-4 py-2 text-xs font-bold uppercase tracking-widest text-gold">
        ...
        <div className="overflow-x-auto rounded-xl bg-card ring-1 ring-border">
          <table className="w-full min-w-[1400px] border-collapse text-xs">
            <thead className="bg-navy text-navy-foreground">
              <tr>
                {["SR", "Date", "Agent", "Pax", "Sector", "PNR", "Airline", "Travel", "Status", "OTB", "Contact", "Vendor", "Sale", "Purchase", "Profit", "Ledger", "Remarks", ""].map((h) => (
