...
function Panel() {
  ...
  return (
    <div className="min-h-screen bg-background animate-premium-fade">
      <header className="border-b border-border bg-[var(--bg-secondary)] text-[var(--text-primary)] w-full">
        <div className="flex items-center justify-between px-0 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] tracking-widest text-[var(--text-secondary)]">Bookings ledger · Reminders · Notifications</p>
            </div>
          </div>
