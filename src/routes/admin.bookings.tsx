          ...
          <table className="w-full table-fixed text-sm">
            ...
            <thead className="bg-navy text-[9.5px] uppercase leading-tight tracking-wider text-white">
              <tr>
                ...
                <th className="px-2 py-2 text-center border-l border-white/10">FARE ID</th>
                <th className="px-2 py-2 text-left border-l border-white/10">Date</th>
                <th className="px-2 py-2 text-center border-l border-white/10">Booking ID</th>
                <th className="px-2 py-2 text-left border-l border-white/10">Agent</th>
                <th className="px-2 py-2 text-left border-l border-white/10">Flight Details</th>
                ...
                <th className="px-2 py-2 text-center border-l border-white/10">PNR</th>
                <th className="px-2 py-2 text-center border-l border-white/10">No.of Seats</th>
