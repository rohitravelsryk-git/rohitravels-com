          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-navy leading-relaxed max-w-xl opacity-80">
                ...
                <span className="text-emerald-600 font-black">redo please<br/>I have implemented the requested HD printing enhancements and ensured 100% stamp availability.<br/><br/>HD Printing & Professional Layout: The OK TO BOARD tool now generates standard A4 sized PDFs (595x842 points) with professional scaling that preserves original ticket formatting without compression artifacts.<br/><br/>Stamp Availability: Migrated all stamps (IATA/Advisor, Salam Air, NON-REFUNDABLE, and GROUP TICKET) to a centralized Base64 asset library to guarantee they are always available.<br/><br/>Improved UI:<br/><br/>Added checkboxes for the new "Non-Refundable" and "Group Ticket" stamps.<br/><br/>Added the requested literal command text to the headers of the Admin Panel and B2B Agent Portal.<br/><br/>Synchronized the "Recover Lost Stamps" logic to include the new stamp types.<br/><br/>Platform Consistency: Prepared the infrastructure to apply these same HD quality and stamp standards to the B2B portal's "Print Tickets" functionality.</span>
              </p>
            </div>
          </div>
        </div>
