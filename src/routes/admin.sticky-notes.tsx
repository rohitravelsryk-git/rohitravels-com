          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-navy leading-relaxed max-w-xl opacity-80">
                ...
                <span className="text-emerald-600 font-black">https://rohitravels.com/agent/profile . error Agent profile not found. FIXED with multi-email fallback and admin auto-provisioning.</span>
              </p>
            </div>
          </div>
        </div>
