...
import { Home, Plane, LogOut, Upload, Download, Loader2, X, Stamp, Ticket, Pencil } from "lucide-react";
        ...
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] font-medium text-white/70">OK TO BOARD stamps</p>
            </div>
          </div>
          <div className="flex gap-2 items-center">
            <button
              ...
              className="mr-2 rounded-lg border border-error/40 px-3 py-1.5 text-[13px] font-medium text-error hover:bg-error-strong hover:text-white transition-colors"
