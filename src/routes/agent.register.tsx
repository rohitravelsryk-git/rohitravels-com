...
export const Route = createFileRoute("/agent/register")({
  ...
  head: () => ({
    meta: [
      { title: "ROHI INTERNATIONAL TRAVELS | Agent Registration" },
      { name: "description", content: "Register as a ROHI International Travels travel agent." },
      { property: "og:title", content: "ROHI INTERNATIONAL TRAVELS | Agent Registration" },
      { property: "og:description", content: "Register as a ROHI International Travels travel agent." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://rohitravels.com/agent/register" },
      { property: "og:image", content: "https://rohitravels.com/assets/rohi-agent-preview.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "ROHI International Travels Agent Registration" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ROHI INTERNATIONAL TRAVELS | Agent Registration" },
      { name: "twitter:description", content: "Register as a ROHI International Travels travel agent." },
      { name: "twitter:image", content: "https://rohitravels.com/assets/rohi-agent-preview.jpg" },
    ],
  }),
