          ...
          <div className="flex gap-2">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-emerald-600 px-4 py-2 text-[10px] font-black uppercase tracking-widest text-white shadow-sm hover:opacity-95"
              >
                All in 1
              </a>
              <button
    ...
    <div className="space-y-4">
      ...
      <div className="hidden">
        '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''
                                            ...
                                            Result: The literal display text has been updated to: '''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n\nLoad the security issues from the scan results and fix the selected issues.


don't give above Response agin
      </div>
    </div>
  );
}
