      ...
      <header className="border-b border-border bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <p className="font-serif text-lg font-black text-navy">ROHI INTERNATIONAL TRAVELS</p>
              <p className="text-[10px] font-semibold tracking-widest text-muted-foreground">DATE CALCULATOR</p>
            </div>
          </Link>
          <Link
            to="/"
            className="inline-flex items-center gap-1.5 rounded-md border border-border bg-white px-3 py-2 text-xs font-semibold text-navy hover:bg-secondary"
          >
