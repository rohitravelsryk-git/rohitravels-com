...
import { Home, Plane, LogOut, Ticket, Stamp, Megaphone, Sparkles, Trash2, ExternalLink, Edit3 } from "lucide-react";
import {
  adminLogout,
  getAnnouncement,
  setAnnouncement,
        ...
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] font-medium text-white/70">Latest Updates studio</p>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mt-8">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-sans text-xl font-black text-navy">Update History</h2>
            <Link
              to="/latest-updates"
              ...
              history.map((item, i) => (
                <div key={item.updatedAt || i} className="group flex items-center gap-4 rounded-xl border border-navy/10 bg-white p-3 transition hover:shadow-md">
                  ...
                  <button
                    ...
                    className="rounded-lg p-2 text-navy/30 hover:bg-error-strong-soft hover:text-error-strong"
                    title="Delete Update"
                  >
