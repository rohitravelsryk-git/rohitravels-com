...
const PUBLIC_FARE_COLUMNS =
  "id,origin,origin_code,origin2,origin2_code,destination,destination_code,destination2,destination2_code,airline,flight_date,flight_number,depart_time,arrive_time,flight_details,baggage,meal,seats,category,price_text,is_featured,sort_order,group_type,hide_fare_after_2h,auto_hide_hours,updated_at,created_at";
